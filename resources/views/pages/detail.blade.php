        ...
        <div class="col-lg-4">
          <div class="card card-details card-right">
            ...
            <div class="members my-2">
              <img src="{{ url('frontend/images/user_ic.png') }}" class="member-image mr-1" />
              <img src="{{ url('frontend/images/user_ic2.png') }}" class="member-image mr-1" />
              <img src="{{ url('frontend/images/user_ic3.png') }}" class="member-image mr-1" />
              <img src="{{ url('frontend/images/user_ic4.png') }}" class="member-image mr-1" />
              <img src="{{ url('frontend/images/member.png') }}" class="member-image mr-1" />
            </div>
            <hr />
            <h2>
              Trip Informations
          ...
          <div class="join-container">
            ...
            <form action="{{ route('checkout_process', $item->id) }}" method="POST">
              @csrf
              <button class="btn btn-block btn-join-now mt-3 py-2" type="submit">Join Now</button></form>
            @endauth
            @guest
